            ...
            <div className="relative">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <AnimatedButton backgroundColor="#000000" onClick={() => handleNavigation('/about')}>
                  <span className="text-zinc-950 py-0 px-[81px]">About me</span>
                </AnimatedButton>
                
                <AnimatedButton backgroundColor="#ffffff" className="border border-gray-200" onClick={handleDownloadResume}>
