      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-24 lg:px-32 xl:px-48">
        <div className="relative border-b border-gray-800 pb-24">
          <div className="flex flex-col items-start">
            ...
            <motion.div style={{ x }} className="absolute bottom-0 right-0 translate-y-1/2">
              <AnimatedButton backgroundColor="#444444" className="text-white">
                <span>Get in touch</span>
              </AnimatedButton>
            </motion.div>
            
            <motion.svg style={{ rotate, scale: 2 }} className="absolute top-12 right-0" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
