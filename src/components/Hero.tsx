...
const Hero = () => {
  ...
  return <motion.section variants={slideUp} initial="initial" animate="animate" className="relative h-screen overflow-hidden">
      {/* Background image with lower z-index */}
      <div style={{
      backgroundImage: `url('/lovable-uploads/0687a79e-6796-4aa0-9b7f-2f387647a9f2.png')`,
      backgroundSize: 'cover',
      backgroundPosition: 'center'
    }} className="absolute inset-0 w-full h-full z-0 bg-gray-400" />
